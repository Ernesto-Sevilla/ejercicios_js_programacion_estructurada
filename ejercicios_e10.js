...
for (let i = 0; i < numPartidos; i++) {
    ...
    console.log(`Resultados del partido ${p.juego}: Los Toros ${p.LosToros}
    - San Fernando ${p.SanFernando}`);
};

// Resultado del partido 1
const p1 = partidos.shift();
console.log(`Resultados del partido ${p1.juego}: Los Toros ${p1.LosToros}
    - San Fernando ${p1.SanFernando}`);

// Resultado del partido 2
const p2 = partidos.shift();
console.log(`Resultados del partido ${p2.juego}: Los Toros ${p2.LosToros}
    - San Fernando ${p2.SanFernando}`);

// Resultado del partido 3
const p3 = partidos.shift();
console.log(`Resultados del partido ${p3.juego}: Los Toros ${p3.LosToros}
    - San Fernando ${p3.SanFernando}`);

// Resultado del partido 4
const p4 = partidos.shift();
console.log(`Resultados del partido ${p4.juego}: Los Toros ${p4.LosToros}
    - San Fernando ${p4.SanFernando}`);

// Resultado del partido 5
const p5 = partidos.shift();
console.log(`Resultados del partido ${p5.juego}: Los Toros ${p5.LosToros}
    - San Fernando ${p5.SanFernando}`);

// Resultado del partido 6
const p6 = partidos.shift();
console.log(`Resultados del partido ${p6.juego}: Los Toros ${p6.LosToros}
    - San Fernando ${p6.SanFernando}`);

// Resultado del partido 7
const p7 = partidos.shift();
console.log(`Resultados del partido ${p7.juego}: Los Toros ${p7.LosToros}
